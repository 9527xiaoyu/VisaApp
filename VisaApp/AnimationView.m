...
-(void)d3_setRotate:(CGFloat)angle duration:(NSTimeInterval)duration completion:(CompletionBlock)completion{
    ...
    [UIView animateWithDuration:duration delay:1 options:options animations:^{
...
-(void)d3_bounce{
    [self d3_bounce:20 duration:DEFAULT_DURATION completion:nil];
}
